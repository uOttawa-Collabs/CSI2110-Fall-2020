...
public class WeightGraph
{
    ...
    void printAllShortestDistances(String vert) throws Exception
    {
        ...
        Map<Vertex<String>, Integer> map = GraphAlgorithms.shortestPathLengths(sGraph, vSource);

        for (Vertex<String> v : map.keySet())
            System.out.println(vSource.getElement() + " to " + v.getElement() + " = " + map.get(v));
    }
