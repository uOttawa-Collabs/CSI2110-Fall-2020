...
public class HashingTest
{
    ...
    public static void main(String[] args)
    {
        ...
        HashTable<String, Integer> linear      = new ArrayHashTable<String, Integer>(size, new StringHash(), null,
                                                                                     new LinearProbeStep());
        HashTable<String, Integer> quadratic   = new ArrayHashTable<String, Integer>(size, new StringHash(), null,
                                                                                     new QuadraticProbeStep());
        HashTable<String, Integer> doubleH     = new ArrayHashTable<String, Integer>(size, new StringHash(),
                                                                                     new ReverseStringHash(),
                                                                                     new DoubleHashStep());
        HashTable<String, Integer> quadDoubleH = new ArrayHashTable<String, Integer>(size, new StringHash(),
                                                                                     new ReverseStringHash(),
                                                                                     new QuadraticDoubleHashStep());
        ...
        doubleH     = new ArrayHashTable<String, Integer>(size, new StringHash(), new ReverseStringHash(),
                                                          new DoubleHashStep());
        quadDoubleH = new ArrayHashTable<String, Integer>(size, new StringHash(), new ReverseStringHash(),
                                                          new QuadraticDoubleHashStep());
    ...
    public void HashAndStats(ArrayList<String> words, HashTable<String, Integer> table)
    {
        ...
        String temp = String
                .format("Type: %24s, Elements: %d, Load Factor: %f, %s, Count for word \"The\": %d", table.type(),
                        table.elements(), table.loadFactor(), table.extraInfo(), table.get("the"));
